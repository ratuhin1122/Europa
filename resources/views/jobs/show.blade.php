        ...
        <section class="md:col-span-3">
            <div class="rounded-lg shadow-md bg-white p-3">
                <div class="flex justify-between items-center">
                    <a class="block p-4 text-blue-700" href="{{ route('jobs.index', $job->id) }}">
    ...
    @auth
        ...
        <div x-data="{ open: false }">
            ...
            <div x-cloak x-show="open" 
                 class="fixed inset-0 flex items-center justify-center bg-black/30 bg-backdrop-blur z-50">
                <div @click.away="open = false" 
                    ...
                    <form method="POST" 
                        ...
                        <x-text id="contact_email" name="contact_email" label="Contact Email" :required="true" />
                        <x-text-area id="message" name="message" label="Message" />
                        <x-text id="location" name="location" label="Location" />
                        <x-file id="resume" name="resume" label="Upload Your Resume (pdf)" :required="true" />
