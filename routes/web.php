...
Route::resource('jobs', JobController::class)->middleware('auth')->only(['create','update','edit','destroy'])->whereUuid('id');
Route::resource('jobs', JobController::class)->except(['create','update','destroy'])->whereUuid('id');
